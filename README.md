...
```bash
-- For training 
./train_gat.sh Dataset vector_zip multiattention_head dropout batchsize epochs

--For Inferece Please note the format must be there
./inference_multi_gat.sh Dataset vector_zip multiattention_head dropout 
